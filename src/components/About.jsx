...
const About = () => {
  return (
    <>
      ...
      >
        Hi, I’m Zuhair Mumtaz — a passionate Frontend / Full Stack Developer
        with hands-on experience in building modern, responsive web applications
        using technologies like React.js, Tailwind CSS and Node.js.
        I’ve worked on real-world personal projects.
      </motion.p>
